...
module counter(clk, rst, \q[0] , \q[1] , \q[2] , \q[3] , \q[4] , \q[5] , \q[6] , \q[7] );
  ...
  always @(posedge clk)
    \q[4]  <= n50;
  assign n38 = 8'h60 >> { rst, \q[0] , \q[1]  };
  assign n42 = 16'h7800 >> { rst, \q[2] , \q[0] , \q[1]  };
  assign n46 = 8'h60 >> { rst, _00_, \q[3]  };
  assign _00_ = 8'h80 >> { \q[0] , \q[1] , \q[2]  };
  assign n50 = 8'h60 >> { rst, _01_, \q[4]  };
  assign _01_ = 16'h8000 >> { \q[0] , \q[1] , \q[2] , \q[3]  };
  assign n22 = 16'h7800 >> { rst, \q[5] , _01_, \q[4]  };
  assign n26 = 8'h60 >> { rst, _02_, \q[6]  };
  assign _02_ = 8'h80 >> { _01_, \q[4] , \q[5]  };
  assign n30 = 8'h60 >> { rst, _03_, \q[7]  };
  assign _03_ = 16'h8000 >> { _01_, \q[4] , \q[5] , \q[6]  };
  assign n34 = 4'h4 >> { rst, \q[0]  };
endmodule
