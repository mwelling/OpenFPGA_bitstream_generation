...
CAPNP_DECLARE_SCHEMA(af7b9956513af632);
CAPNP_DECLARE_SCHEMA(d4581dba2ab3267a);
...
struct Matrix {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(af7b9956513af632, 0, 2)
    #if !CAPNP_LITE
...
struct Matrix<Value>::Entry {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(d4581dba2ab3267a, 0, 1)
    #if !CAPNP_LITE
    static const ::capnp::_::RawBrandedSchema::Scope brandScopes[];
    static const ::capnp::_::RawBrandedSchema::Binding brandBindings[];
    static const ::capnp::_::RawBrandedSchema specificBrand;
...
const ::capnp::_::RawBrandedSchema::Scope Matrix<Value>::Entry::_capnpPrivate::brandScopes[] = {
  { 0xaf7b9956513af632, brandBindings + 0, 1, false},
};
template <typename Value>
...
const ::capnp::_::RawBrandedSchema Matrix<Value>::Entry::_capnpPrivate::specificBrand = {
  &::capnp::schemas::s_d4581dba2ab3267a, brandScopes, nullptr,
  1, 0, nullptr
};
#endif  // !CAPNP_LITE
...
const ::capnp::_::RawBrandedSchema Matrix<Value>::_capnpPrivate::specificBrand = {
  &::capnp::schemas::s_af7b9956513af632, brandScopes, brandDependencies,
  1, 1, nullptr
};
#endif  // !CAPNP_LITE
