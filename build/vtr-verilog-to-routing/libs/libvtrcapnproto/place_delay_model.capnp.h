...
CAPNP_DECLARE_SCHEMA(a0f080646558efc3);
CAPNP_DECLARE_SCHEMA(c277cc627087785e);
CAPNP_DECLARE_SCHEMA(e23edb66d9eb1a1e);
CAPNP_DECLARE_SCHEMA(a9331305ff92a75f);
...
struct VprFloatEntry {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(a0f080646558efc3, 1, 0)
    #if !CAPNP_LITE
...
struct VprDeltaDelayModel {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(c277cc627087785e, 0, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct VprOverrideEntry {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(e23edb66d9eb1a1e, 2, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct VprOverrideDelayModel {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(a9331305ff92a75f, 0, 2)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
